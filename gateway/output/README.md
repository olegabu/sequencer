...
counterpart, or `examples/counter/demo_http_websocket.sh` for a live walkthrough
...
the `grpcurl` counterpart to `demo_http_websocket.sh` — and `--brpc_port` selects the
